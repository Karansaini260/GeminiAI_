...
# configration google.generativeai with API key
...
def gemini_pro_vision_response(prompt,image):
    gemini_pro_vision_model = genai.GenerativeModel("gemini_pro_vision")
...
def gemini_pro_response(prompt):
    gemini_pro_model = load_gemini_pro_model("gemini-pro")
